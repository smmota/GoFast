...
namespace GoFast.API.Migrations
{
    ...
    [Migration("20230602044856_criandoTabelas-v9")]
    partial class criandoTabelasv9
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoFast.API.Entities.BlobStorage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GoFast.API.Entities.Carro", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoFast.API.Entities.Documento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoFast.API.Entities.Endereco", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoFast.API.Entities.Motorista", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoFast.API.Entities.DocumentoCarro", b =>
                {
                    b.HasBaseType("GoFast.API.Entities.Documento");
            ...
            modelBuilder.Entity("GoFast.API.Entities.Carro", b =>
                {
                    b.HasOne("GoFast.API.Entities.DocumentoCarro", "DocumentoCarro")
                        .WithMany()
            ...
            modelBuilder.Entity("GoFast.API.Entities.Documento", b =>
                {
                    b.HasOne("GoFast.API.Entities.BlobStorage", "Blob")
                        .WithMany()
            ...
            modelBuilder.Entity("GoFast.API.Entities.Motorista", b =>
                {
                    b.HasOne("GoFast.API.Entities.Carro", "Carro")
                        .WithMany()
                        .HasForeignKey("Motorista.Carro")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GoFast.API.Entities.Endereco", "Endereco")
                        .WithMany()
